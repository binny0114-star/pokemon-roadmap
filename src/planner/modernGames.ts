...
const kalosBosses = [
  ...
  boss('korrina', '코르니', '사라 체육관', 3, ['fighting'], 'Lv.28–32'),
...
const ultraBosses = [
  ...
  boss('lusamine-usum', '루자미네', '에테르대표', 5, ['fairy', 'normal', 'fighting', 'grass', 'water', 'ghost'], 'Lv.47'),
...
const galarBosses = [
  boss('hop-route-2', '호브', '2번도로 라이벌전', 1, ['normal'], 'Lv.5–8', { sequence: 1 }),
  ...
  boss('bede-mine-2', '비트', '제2광산 라이벌전', 4, ['psychic'], 'Lv.21–23'),
  ...
  boss('bede-stow', '비트', '래터럴마을 라이벌전', 5, ['psychic'], 'Lv.32–35'),
  ...
  boss('hop-circhester', '호브', '키르쿠스마을 라이벌전', 7, ['normal'], 'Lv.39–41'),
  boss('marnie-spikemuth', '마리', '9번도로 라이벌전', 8, ['dark'], 'Lv.42–44'),
  ...
  boss('hop-cup', '호브', '챔피언컵 준결승', 10, ['normal'], 'Lv.47–49'),
  boss('oleana', '올리브', '로즈타워', 10, ['poison', 'ice'], 'Lv.50–52'),
  boss('bede-finals', '비트', '챔피언컵 난입전', 10, ['fairy'], 'Lv.51–53'),
  boss('nessa-finals', '야청', '챔피언컵 결승', 10, ['water'], 'Lv.51–53'),
  ...
  boss('hop-final', '호브', '포스트게임 마지막 승부', 11, ['normal'], 'Lv.68–70'),
...
const sinnohRemakeChapters = [
  ...
  chapter('bd-5', '연고시티 → 봉신마을', '레릭배지와 파도타기', 'Lv.30–36', ['route-212', 'pokemon-mansion', 'hearthome', 'route-210', 'celestic', 'route-211'], ['연고체육관 멜리사 격파', '봉신마을 유적 앞 갤럭시단 조무래기 격파'], ['포켓치 비전기술 파도타기']),
...
const sinnohRemakeBosses = [
  ...
  boss('galactic-veilstone-double', '갤럭시단 조무래기 2명', '빛나/광휘와 더블배틀', 3, ['poison', 'bug'], 'Lv.25'),
  boss('wake-bdsp', '맥실러', '들판 체육관', 4, ['water'], 'Lv.27–30'),
  boss('barry-pastoria', '라이벌', '들판시티', 4, ['normal'], 'Lv.25–28'),
  boss('fantina-bdsp', '멜리사', '연고 체육관', 5, ['ghost'], 'Lv.32–36'),
  // 봉신마을에서 태홍은 대화만 하며, 실제 전투 상대는 유적 앞 갤럭시단 조무래기입니다. 진행 기록 호환을 위해 ID는 유지합니다.
  boss('cyrus-celestic', '갤럭시단 조무래기', '봉신마을 유적 입구', 5, ['bug', 'poison'], 'Lv.25–27'),
  boss('barry-canalave', '라이벌', '운하시티', 6, ['normal'], 'Lv.30–35'),
  boss('byron-bdsp', '동관', '운하 체육관', 6, ['steel'], 'Lv.36–39'),
  boss('saturn-lake-valor', '새턴', '입지호수', 7, ['poison', 'psychic'], 'Lv.35–37'),
  boss('mars-lake-verity', '마스', '진실호수', 7, ['dark', 'poison'], 'Lv.37–39'),
  ...
  boss('barry-league', '라이벌', '신오리그 입구', 10, ['normal'], 'Lv.48–53'),
...
const paldeaBosses = [
  ...
  boss('orthworm-titan', '꿈트렁', '잠강의 주인', 5, ['steel'], 'Lv.29'),
  ...
  boss('quaking-earth-titan', '위대한엄니/무쇠바퀴', '토진의 주인', 7, ['ground'], 'Lv.45'),
  boss('tulip', '리파', '베이크 체육관', 8, ['psychic'], 'Lv.44–45'),
  boss('grusha', '그루샤', '나페산 체육관', 8, ['ice'], 'Lv.47–48'),
  boss('ortega', '오르티가', '페어리 군단', 8, ['fairy'], 'Lv.50–51'),
  boss('false-dragon-titan', '어써러셔·싸리용', '위룡의 주인', 9, ['water', 'dragon'], 'Lv.56–57'),
